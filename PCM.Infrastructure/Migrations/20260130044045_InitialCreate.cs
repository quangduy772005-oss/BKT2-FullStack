        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateOfBirth = table.Column<DateTime>(type: "datetime2", nullable: true),
                    JoinDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    RankELO = table.Column<double>(type: "float(10)", precision: 10, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DepositRequests_Members_MemberId",
                        column: x => x.MemberId,
                        principalTable: "Members",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Matches_Members_Team1Player1Id",
                        column: x => x.Team1Player1Id,
                        principalTable: "Members",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Matches_Members_Team1Player2Id",
                        column: x => x.Team1Player2Id,
                        principalTable: "Members",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Matches_Members_Team2Player1Id",
                        column: x => x.Team2Player1Id,
                        principalTable: "Members",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Matches_Members_Team2Player2Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PricePerSession = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InitialRanking = table.Column<int>(type: "int", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EncryptedSignature = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WalletTransactions_TransactionCategories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                name: "MiniGameResults",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MatchId = table.Column<int>(type: "int", nullable: false),
                    TeamAPoints = table.Column<int>(type: "int", nullable: false),
                    TeamBPoints = table.Column<int>(type: "int", nullable: false),
                    TeamWinner = table.Column<int>(type: "int", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MiniGameResults", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MiniGameResults_Matches_MatchId",
                        column: x => x.MatchId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TournamentMatches_TournamentMatches_ParentMatchId",
            ...
            migrationBuilder.InsertData(
                table: "Courts",
                columns: new[] { "Id", "Capacity", "CreatedDate", "Description", "IsActive", "ModifiedDate", "Name", "PricePerHour" },
                values: new object[,]
                {
                    { 1, 4, new DateTime(2026, 1, 30, 4, 40, 44, 671, DateTimeKind.Utc).AddTicks(9006), "Sân cỏ tự nhiên", true, null, "Sân 1", 150000m },
                    { 2, 4, new DateTime(2026, 1, 30, 4, 40, 44, 671, DateTimeKind.Utc).AddTicks(9007), "Sân nhân tạo", true, null, "Sân 2", 120000m },
                    { 3, 4, new DateTime(2026, 1, 30, 4, 40, 44, 671, DateTimeKind.Utc).AddTicks(9009), "Sân trong nhà", true, null, "Sân 3", 180000m }
                });

            migrationBuilder.InsertData(
                table: "TransactionCategories",
                columns: new[] { "Id", "CreatedDate", "IsActive", "ModifiedDate", "Name", "Type" },
                values: new object[,]
                {
                    { 1, new DateTime(2026, 1, 30, 4, 40, 44, 671, DateTimeKind.Utc).AddTicks(8815), true, null, "Nạp tiền", 0 },
                    { 2, new DateTime(2026, 1, 30, 4, 40, 44, 671, DateTimeKind.Utc).AddTicks(8818), true, null, "Phí sân", 1 },
                    { 3, new DateTime(2026, 1, 30, 4, 40, 44, 671, DateTimeKind.Utc).AddTicks(8820), true, null, "Thưởng giải đấu", 2 },
                    { 4, new DateTime(2026, 1, 30, 4, 40, 44, 671, DateTimeKind.Utc).AddTicks(8821), true, null, "Hoàn tiền hủy sân", 3 }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Court_TimeSlot",
                table: "Bookings",
                columns: new[] { "CourtId", "StartTime", "EndTime" });

            migrationBuilder.CreateIndex(
                name: "IX_DepositRequests_MemberId_CreatedDate",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MiniGameResults_MatchId",
                table: "MiniGameResults",
                column: "MatchId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TournamentMatches_ParentMatchId",
                table: "TournamentMatches",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TournamentParticipants_TournamentId_MemberId",
                table: "TournamentParticipants",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WalletTransactions_MemberId_CreatedDate",
                table: "WalletTransactions",
                columns: new[] { "MemberId", "CreatedDate" });
        }
